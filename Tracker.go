...
func isiDataContoh() {
	contoh := [3]Proyek{
		...
		{ID: 2, NamaProyek: "Dashboard Analytics", NamaKlien: "CV Data Pintar",
			Deskripsi: "Dashboard monitoring data penjualan", Status: StatusBerjalan,
			Bayaran: 6000000, TanggalMulai: "01/05/2026", Deadline: "15/06/2026", Aktif: true},
		{ID: 3, NamaProyek: "Landing Page Promosi", NamaKlien: "Brand Lokal ID",
			Deskripsi: "Halaman promo produk seasonal", Status: StatusSelesai,
			Bayaran: 1500000, TanggalMulai: "01/04/2026", Deadline: "20/04/2026", Aktif: true},
	}
	i := 0
	for i < 3 {
